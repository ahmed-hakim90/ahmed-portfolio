...
**استثناء مهم:** لو اليوزر **سبق وأكمل الـ onboarding مرة** ثم **فتح المعالج تاني** من الإعدادات، نعرض **الداتا المحفوظة مباشرة** (مش تصفير)، لأن دي تعديل على محفظة جاهزة مش «أول إنشاء».
...
2. **طالما الداتا ناقصة أو فاضية أو لم تُمشَ كل الخطوات:** ما ينفعش للزائر يشوف محفظة حقيقية — **ولا معاينة عامة** (نفس قاعدة الزائر).
